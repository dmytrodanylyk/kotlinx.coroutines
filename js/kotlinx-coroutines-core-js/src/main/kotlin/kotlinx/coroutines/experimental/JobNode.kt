...
internal actual abstract class JobNode<out J : Job> actual constructor(
    ...
    actual val asHandler: CompletionHandler = { invoke(it) }
    init { asHandler.asDynamic().__JobNode = this }
    ...
    actual abstract fun invoke(reason: Throwable?)
}

internal actual val CompletionHandler.asJobNode: JobNode<*>?
    get() = asDynamic().__JobNode ?: null